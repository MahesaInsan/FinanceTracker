...
Route::middleware('auth:sanctum')->group(function () { // harus udah ada token
    ...
    Route::post('/transaction', [App\Http\Controllers\TransactionController::class, 'setTransaction']);
    Route::get('/transaction', [App\Http\Controllers\TransactionController::class, 'getTransaction']);
