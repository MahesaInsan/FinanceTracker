    ...
    return(
        <div className="flex flex-col gap-4">
            <div className="flex flex-row justify-between">
                ...
                <button className="p-2 border-2 rounded-xl text-medium border-[#3A89A0] text-[#3A89A0] w-[16rem] font-medium hover:bg-[#3A89A0] hover:text-white" onClick={()=>setOpenModal(true)}>
                    Add Wallet
                </button>
