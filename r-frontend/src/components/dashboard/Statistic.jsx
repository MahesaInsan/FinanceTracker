  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="Description">
        ...
        <p className="text-l">
          Here is a visualization of the amount of expenses and income that
          exist in the period of this month, {date} {year}
        </p>
      </div>
      <div className="Graph flex flex-col lg:flex-row justify-between">
        ...
        <div className="flex flex-col md:flex-row lg:flex-col gap-2 justify-evenly items-center grow">
          <TotalMoneyBox
            title={"Current Money"}
            description={`Rp. ${numberWithCommas(total)}`}
            color={"text-xl font-semibold minw-[20%]"}
          ></TotalMoneyBox>
          <TotalMoneyBox
            title={"Total Income"}
            description={`Rp. ${numberWithCommas(income)}`}
            color={"text-xl font-semibold text-[#62C668] minw-[20%]"}
          ></TotalMoneyBox>
          <TotalMoneyBox
            title={"Total Expense"}
            description={`Rp. ${numberWithCommas(expense)}`}
      ...
      <div>
        {income > expense ? (
          <div>
            <p className="text-2xl text-[#62C668] font-semibold">
              You are awesome! 👍
            </p>
            <p className="text-l">
              Your spending transactions are still within safe limits. You can
              continue to be consistent in maintaining your spending limit.
            </p>
          </div>
        ) : (
          <div>
            <p className="text-2xl text-[#DF2424] font-semibold">
              Uh oh you are a spender! 👎
            </p>
            <p className="text-l">
              Your spending transactions are outside of within safe limits. You
              can should decrease your spending a little bit.
            </p>
          </div>
        )}
      </div>
